...
# ID 판독은 이 모듈 일이 아니다 — ExtractAgent 소유의 공용 판독기를 쓴다.
# (ActionAgent 계열 코드가 여기 것을 import 하던 관성이 있어 이름만 이어준다)
from app.id_reader import extract_ids, id_candidates  # noqa: F401 (재수출)
